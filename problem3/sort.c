...
int main() {
    const char* file_map[4][6] = {
        { "data/data_100.txt", "data/data_100_copy1.txt", "data/data_100_copy2.txt", "data/data_100_copy3.txt", "data/data_100_copy4.txt", "data/data_100_copy5.txt" },
        { "data/data_1000.txt", "data/data_1000_copy1.txt", "data/data_1000_copy2.txt", "data/data_1000_copy3.txt", "data/data_1000_copy4.txt", "data/data_1000_copy5.txt" },
        { "data/data_10000.txt", "data/data_10000_copy1.txt", "data/data_10000_copy2.txt", "data/data_10000_copy3.txt", "data/data_10000_copy4.txt", "data/data_10000_copy5.txt" },
        { "data/data_100000.txt", "data/data_100000_copy1.txt", "data/data_100000_copy2.txt", "data/data_100000_copy3.txt", "data/data_100000_copy4.txt", "data/data_100000_copy5.txt" },
    };
    ...
    for (int i = 0; i < 4; i++) {  // 데이터 크기별
    printf("\n=== 데이터 크기: %s ===\n", file_map[i][0]);

    for (int j = 0; j < 6; j++) {  // 알고리즘별
        int data[MAX_SIZE], n;
